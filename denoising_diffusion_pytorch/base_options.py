...
class BaseOptions():
    def __init__(self):
        ...
        #Experiment Details
        self.parser.add_argument('--name',type=str,default='dna_uncond_test1')
        self.parser.add_argument('--results_folder', type=str, 
            default='C:/Users/stonks/OneDrive - The Alan Turing Institute/Desktop/Cell_GSK_Dataset/results/uncond/low_res/',help='path to save samples')
        ...
        self.parser.add_argument('--self_condition',type=bool,default=False, help='whether to condition on noise and additonal info')
        ...
        #Diffusion
        self.parser.add_argument('--image_size',type=int,default=655, help='size you want to train on (if smaller than original image_size a crop will be taken)')
        self.parser.add_argument('--sampling_timesteps',type=int,default=250)
        self.parser.add_argument('--original_image_size',type=int,default=655, help='size of input image')
        ...
        self.parser.add_argument('--gradient_accumulate_every',type=int,default=2)
        self.parser.add_argument('--train_lr',default=8e-5, help='learning rate')
        self.parser.add_argument('--train_num_steps',type=int,default=700000, help='number of steps')
        ...
        self.parser.add_argument('--save_and_sample_every',type=int,default=50000, help='number of steps after to save milestone and sample')
