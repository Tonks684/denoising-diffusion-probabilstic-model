...
class BaseOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--folder_A',type=str,
            default='C:/Users/stonks/OneDrive - The Alan Turing Institute/Desktop/Cell_GSK_Dataset/total/train_A/', help='/path/to/image/folder/A/')
        self.parser.add_argument('--folder_B',type=str,
            default='C:/Users/stonks/OneDrive - The Alan Turing Institute/Desktop/Cell_GSK_Dataset/total/train_B/', help='/path/to/image/folder/B/')        
                #Generator
        self.parser.add_argument('--init_dim', type=int, default=64, help='initial conv layer output channels')
        self.parser.add_argument('--dim_mults', type=tuple, default= (1,2,4,8), help='output channel at each encoder layer is --dim*dim_mults[i]')
        ...
        self.parser.add_argument('--resnet_block_groups', type=int, default=8, help='total number of resent blocks')
        ...
        #Diffusion
        self.parser.add_argument('--image_size',type=int,default=256, help='size you want to train on (if smaller than original image_size a crop will be taken)')
        self.parser.add_argument('--sampling_timesteps',type=int,default=None)
        self.parser.add_argument('--original_image_size',type=int,default=1080, help='size of input image')
        ...
        #Training
        self.parser.add_argument('--train_batch_size',type=int,default=1, help='batch size')
        ...
        self.parser.add_argument('--save_and_sample_every',type=int,default=200, help='number of steps after to save milestone and sample')
        self.parser.add_argument('--num_samples',type=int,default=5, help='number of samples per sample')
        ...
        self.parser.add_argument('--split_batches', type=bool,default=True, help='Split batches')
